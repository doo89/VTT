    ...
    <div className="flex flex-col gap-6">
      ...
      <section className="flex flex-col gap-3">
        <div 
          ...
          onClick={() => toggleSection('createCategory')}
        >
          <h3 className="font-semibold text-sm">Créer une Catégorie</h3>
          {openSections.createCategory ? <ChevronDown size={16} className="text-blue-500" /> : <ChevronRight size={16} className="text-blue-500" />}
        </div>
      ...
      <section className="flex flex-col gap-3">
        <div 
          ...
          onClick={() => toggleSection('createTag')}
        >
          <h3 className="font-semibold text-sm">Créer un Tag</h3>
          {openSections.createTag ? <ChevronDown size={16} className="text-blue-500" /> : <ChevronRight size={16} className="text-blue-500" />}
        </div>
      ...
      <section className="flex flex-col gap-3">
        <div 
          className="flex items-center justify-between bg-accent/30 hover:bg-accent/50 p-2 rounded cursor-pointer transition-colors border-t border-border mt-2"
          onClick={() => toggleSection('tagList')}
        >
          <h3 className="font-semibold text-sm">Modèles Disponibles</h3>
          {openSections.tagList ? <ChevronDown size={16} className="text-blue-500" /> : <ChevronRight size={16} className="text-blue-500" />}
        </div>
        
        {openSections.tagList && (
